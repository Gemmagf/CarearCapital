...
const translations = {
  catalan: {
    ...
    cv: {
      ...
      summaryTitle: "Perfil",
      featuredProjectTitle: "Projecte destacat",
      techMethodsTitle: "Tecnologies i metodologies",
      methodsLabel: "Mètodes",
  ...
  spanish: {
    ...
    cv: {
      ...
      techMethodsTitle: "Tecnologías y metodologías",
  ...
  english: {
    ...
    cv: {
      ...
      techMethodsTitle: "Tech & Methodologies",
  ...
  french: {
    ...
    cv: {
      ...
      summaryTitle: "Profil",
      featuredProjectTitle: "Projet phare",
      techMethodsTitle: "Tech & Méthodologies",
  ...
  german: {
    ...
    cv: {
      ...
      summaryTitle: "Profil",
      featuredProjectTitle: "Ausgewähltes Projekt",
      techMethodsTitle: "Tech & Methoden",
  ...
  italian: {
    ...
    cv: {
      ...
      techMethodsTitle: "Tech & Metodologie",
      methodsLabel: "Metodi",
      techStackTitle: "Tech Stack",
