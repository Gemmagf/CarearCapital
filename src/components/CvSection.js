...
const CvSection = () => {
  const education = [
    // Aquí pots afegir la teva educació si la tens disponible
  ];
  ...
  return (
    <section className="p-8 bg-white rounded-2xl shadow-lg mx-4 my-6">
      <h2 className="text-4xl font-bold text-gray-800 mb-8 text-center">Habilitats i Formació</h2>

      {education.length > 0 && (
        <div className="mb-10">
          <h3 className="text-3xl font-semibold text-gray-700 mb-6 border-b-2 border-gray-300 pb-2">Formació</h3>
          {education.map((edu) => (
      ...
      <div>
        <h3 className="text-3xl font-semibold text-gray-700 mb-6 border-b-2 border-gray-300 pb-2">Habilitats Clau</h3>
