        ...
        if pwd != "" and pwd != pwd:
            ...
            if st.button('Guardar'):
                if date.today() not in df['Data']: 
                    ...
                    st.write("La teva informació s'ha guardat correctament")
                else:
                    df.loc[df['Data'] == Data, len(df)] = d
                    st.write("L'informació d'avui ja hi es , pero hem reescrit la linia amb respostes noves ")
